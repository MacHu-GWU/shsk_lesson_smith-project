...
readup 是纯阅读型仓库: 不带任何 AI 学习工具链, 也没有任何特殊 Task, 所以它比 upskill 和 showcase 少一个锻造阶段, 也少了写 quiz 那一段. 一共 10 步 6 个阶段.
...
| 两头都在, 根目录缺 `README-cn.md` 或 `TICKET-cn.md` | 第 8 步或第 9 步. **直接问创作者统稿做没做**, 这一步从文件系统看不出来 |
