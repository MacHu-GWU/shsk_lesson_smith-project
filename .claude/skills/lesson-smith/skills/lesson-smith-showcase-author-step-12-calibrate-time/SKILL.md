---
name: lesson-smith-showcase-author-step-12-calibrate-time
description: "第 12 步: 梳理全部 Task 的预计用时, 出一张汇总表让创作者按档位拍板, 再改回各 TICKET"
argument-hint: "[自由说明...]"
---

# showcase 创作流 第 12 步

你在 **showcase 创作工作流的第 12 步**: 统稿之后, 横着比一遍 `examples/` 下全部 Task, 把六档预计用时分配到位.
...
- **一个 Task 都不许漏.** 索引, quiz, demo, 收尾这几个位置固定的 Task 也在 `examples/` 下, 也算数, 档位一样要过一遍.
