...
- [mise.toml 的 tasks 部分](../../mise.toml): [常用命令] (怎么跑见 docs/upskill/02-upskill-runbook-cn.md)

## 2. 引导路径

[examples/01, 02 ... 这条渐进序列就是学生要走的路. 概述整条线怎么推进, 点向索引 Task 与 SYLLABUS, 不要逐条复述每个 Task.]
