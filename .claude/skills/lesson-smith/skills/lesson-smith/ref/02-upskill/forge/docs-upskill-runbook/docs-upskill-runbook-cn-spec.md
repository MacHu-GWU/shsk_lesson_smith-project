# docs/upskill/02-upskill-runbook-cn.md 规范, 中文版

**适用范围**: upskill 类型 repo 的 `docs/upskill/02-upskill-runbook-cn.md`, 由 `lesson-smith-upskill-forge` 生成, 给 `upskill-learn-cn` skill 消费.

**配套骨架**: [docs-upskill-runbook-cn-template.md](docs-upskill-runbook-cn-template.md).
...
- 不做索引 (那是 `01-upskill-learn-cn.md` 的活).
