...
当前是**中文单语种**. 工作流里没有翻译, 也没有中译英的重写环节; 产出英文的那部分以后作为独立的多语种模块单独做.

维护 ref 时因此有两条:

- 新写的规范不要再出现 "英文版专属" 这类小节, 也不要写按语种分档的预算.
...
- **语种完整性**: `linter.py` 现在的规则是 "任一语种存在则所有语种都要存在". 中文单语种的 repo 会被判缺英文版, 需要放宽.
