...
- 每个 H2 下遵循四段结构 (规范但不死板). 每段有固定的 short title, 用加粗标签:
...
**问题:** [面试官会直接问的那句话, 1 到 3 句. 必须是 repo 里教过, 有据可查的东西.]

**考察点:** [这题的潜台词, 想看你会不会什么. 纯知识点题就直说考的是题面, 不强行拔高.]

**参考回答:** [面试里 1 到 3 分钟能说出口的精炼回答, 知其然.]

**深入解读:** [旁白把知识讲透, 知其所以然, 允许冗余. 溯源: 见 [某文件的某节](../../path/to/file.md) 里讲 xxx 的部分, 以及 [某段代码](../../path/to/code.py) 里的 `some_function`.]
