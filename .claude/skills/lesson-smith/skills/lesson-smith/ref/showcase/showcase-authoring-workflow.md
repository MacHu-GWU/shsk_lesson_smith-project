...
前置: 创作者以中文为母语, 遵循创作铁律 (先写 cn, 全部定稿后一次性用 rewrite-en-tutorial 重写成 en) 和 markdown-style, chinese-english-punctuation 两个 Agent Skill. 整体布局见 [ref/showcase/showcase-repo-layout.md](showcase-repo-layout.md).
