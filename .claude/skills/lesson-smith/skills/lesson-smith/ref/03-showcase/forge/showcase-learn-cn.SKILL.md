...
- 真材料: `examples/` 下各个教学 Task 的 `README-cn.md`, 加上索引指向的那些学习素材文件. 结尾那个 quiz Task 和 demo Task 不归你管, 它们分别属于 `showcase-quiz-cn` 与 `showcase-demo-cn`. **讲某一处时要去读真正的文件**, 不要拿索引转述一遍就算.
