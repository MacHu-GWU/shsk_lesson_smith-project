---
name: lesson-smith-showcase-author-step-07-to-08-quiz
description: "第 7 到 8 步: 扫全部教学内容规划题库, 再写 quiz 那个固定 Task 的题库 README 与 TICKET"
argument-hint: "[自由说明...]"
disable-model-invocation: true
---

# showcase 创作流 第 7 到 8 步

你在 **showcase 创作工作流的第 7 到 8 步**: 规划并写出 quiz 那个特殊 Task, 目录名 `examples/NN-prove-i-get-it`.

主剧本是 `lesson-smith` skill 的 `ref/03-showcase/showcase-authoring-workflow.md`, 本步对应它的第 8 到 9 节. 先读那两节接上上下文, 再按下面动手.
...
- `ref/03-showcase/showcase-quiz-readme-spec/`: 题库真身的问答结构 (每题一个 H2, 四段).
- `ref/03-showcase/showcase-quiz-ticket-spec/`: 它的 TICKET, 内容固定极简.
...
- 目录名固定 `NN-prove-i-get-it`, forge 与 publish 都靠这个名字定位它, 不许改.
- **只考技术知识.** 关于这段经历和方法的元问题 (为什么选这个技能, AI 生成的东西你真懂吗, 最大的坑是什么) 归第 9 步的 demo, **别混进题库**. 两边都写就是两处各说一半, 学生哪边都练不透.
- **位置排在 demo 之前.** demo 的七幕里有一幕要指向 quiz 当产物, quiz 不先写, 那一幕没东西可指.
